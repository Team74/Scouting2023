...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.MyViewHolder> {
    ...
    private ArrayList match_id, matchNum, teamNum, numCones, numCubes, balance;
    Activity activity;


    CustomAdapter(Activity activity, Context context, ArrayList match_id, ArrayList matchNum, ArrayList teamNum, ArrayList numCones, ArrayList numCubes, ArrayList balance)
    {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        if(canBalance.equals("1"))
        {
            Log.d("Test", "true " + canBalance);
            holder.balance_txt.setText("Yes");
        }else{
            Log.d("Test", "false " + canBalance);
            holder.balance_txt.setText("No");
        }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView match_id_txt, matchNum_txt, teamNum_txt, numCones_txt, numCubes_txt, balance_txt;
