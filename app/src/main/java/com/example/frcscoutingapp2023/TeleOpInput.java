...
public class TeleOpInput extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toTeleOp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("autoHighCones", autoHighCones);
                intent.putExtra("autoMidCones", autoMidCones);
                intent.putExtra("autoLowCones", autoLowCones);
                intent.putExtra("autoHighCubes", autoHighCubes);
                intent.putExtra("autoMidCubes", autoMidCubes);
                intent.putExtra("autoLowCubes", autoLowCubes);
                intent.putExtra("autoBalance", autoBalance);

                intent.putExtra("teleOpHighCones", highConeInt);
                intent.putExtra("teleOpMidCones", midConeInt);
                intent.putExtra("teleOpLowCones", lowConeInt);
                intent.putExtra("teleOpHighCubes", highCubeInt);
                intent.putExtra("teleOpMidCubes", midCubeInt);
                intent.putExtra("teleOpLowCubes", lowCubeInt);
                intent.putExtra("teleOpBalance", team1BalanceInt);
